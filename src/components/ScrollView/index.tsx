...
export let ScrollViewComponent;
...
if (process.env.TARO_ENV === 'weapp') {
  const { ScrollView: ScrollViewTaro } = require('@tarojs/components');

  ScrollViewComponent = ScrollViewTaro;
} else {
  ...
  class ScrollViewH5 extends React.Component<ScrollViewProps> {
    ...
    render() {
      ...
      upperThreshold = parseInt(upperThreshold.toString());
      lowerThreshold = parseInt(lowerThreshold.toString());
  ...
  ScrollViewComponent = ScrollViewH5;
}
